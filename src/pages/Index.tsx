...
import { Zap, Shield, Users, BarChart3, ArrowRight, CheckCircle, Star } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Get instant summaries of your Slack conversations and channels with AI-powered insights"
    },
    {
      icon: Shield,
      title: "Secure Integration",
      description: "Your data is safe with enterprise-grade security and OAuth authentication"
    },
    {
      icon: Users,
      title: "Team Collaboration",
      description: "Share summaries with your team and stay aligned across all channels"
    },
    {
      icon: BarChart3,
      title: "Analytics & Insights",
      description: "Track conversation trends and team engagement with detailed analytics"
    }
  ];
  ...
  const testimonials = [
    {
      ...
      company: "TechFlow",
      content: "This tool has transformed how our team stays updated. No more missing important discussions!",
      rating: 5
    },
    {
      ...
      company: "DataCorp",
      content: "The AI summaries are incredibly accurate. It's like having a personal assistant for Slack.",
      rating: 5
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24">
          <div className="text-center animate-fade-in">
            ...
            <h1 className="text-6xl font-bold text-gray-900 mb-6 leading-tight">
              Transform Your
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600"> Slack</span>
              <br />
              Into Organized
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              Stop drowning in Slack messages. Get AI-powered summaries of conversations, 
              channels, and meetings to stay informed without the overwhelm.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Powerful features designed to transform how your team stays connected and informed
            </p>
          </div>
      ...
      <div className="relative py-24 bg-gradient-to-r from-purple-600 to-blue-600 text-white overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-purple-100 mb-10 max-w-2xl mx-auto">
            Join thousands of teams who are already using AI to stay on top of their conversations.
