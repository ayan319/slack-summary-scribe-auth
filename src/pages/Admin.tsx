...
const MOCK_ADMIN_SUMMARIES: HistoryItem[] = [
  {
    ...
    summary: {
      candidateSummary:
        "Strong technical candidate with 5 years React experience",
  ...
  },
  {
    ...
    summary: {
      candidateSummary:
        "Mid-level developer with good potential but needs mentoring",
          ...
          <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow mb-6">
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">
                This area is restricted to administrators only. Enable admin
                mode below for testing purposes.
              </p>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Manage all user summaries and interviews
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setFilters((prev) => ({ ...prev, userSearch: e.target.value }))
              }
            />
          </div>
          <div className="flex items-center gap-2">
          ...
          <Button
            variant="outline"
            onClick={() =>
              setFilters({ search: "", tags: [], rating: null, userSearch: "" })
            }
          >
            Clear Filters
          </Button>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {summaries.length > 0
                  ? (
                      summaries.reduce((acc, s) => acc + s.summary.rating, 0) /
                      summaries.length
                    ).toFixed(1)
                  : "N/A"}
              </div>
